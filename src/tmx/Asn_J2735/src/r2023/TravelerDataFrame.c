...
asn_TYPE_member_t asn_MBR_TravelerDataFrame_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame, notUsed),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SSPindex,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame, notUsed1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame, notUsed2),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame, notUsed3),
...
static const asn_TYPE_tag2member_t asn_MAP_TravelerDataFrame_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* notUsed1 */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* regions */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 }, /* notUsed2 */
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 }, /* notUsed3 */
