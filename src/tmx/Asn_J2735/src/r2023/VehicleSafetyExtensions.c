...
asn_TYPE_member_t asn_MBR_VehicleSafetyExtensions_1[] = {
	{ ATF_POINTER, 6, offsetof(struct VehicleSafetyExtensions, events),
	...
	{ ATF_POINTER, 5, offsetof(struct VehicleSafetyExtensions, pathHistory),
	...
	{ ATF_POINTER, 4, offsetof(struct VehicleSafetyExtensions, pathPrediction),
	...
	{ ATF_POINTER, 3, offsetof(struct VehicleSafetyExtensions, lights),
	...
	{ ATF_POINTER, 2, offsetof(struct VehicleSafetyExtensions, timestamp),
	...
	{ ATF_POINTER, 1, offsetof(struct VehicleSafetyExtensions, height),
...
static const int asn_MAP_VehicleSafetyExtensions_oms_1[] = { 0, 1, 2, 3, 4, 5 };
...
static const asn_TYPE_tag2member_t asn_MAP_VehicleSafetyExtensions_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* height */
};
